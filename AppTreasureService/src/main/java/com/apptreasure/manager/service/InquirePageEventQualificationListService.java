 ...
 */
@ServiceConfig(
        act = AppTreasureActionNames.inquirePageEventQualificationList,
        ...
        returnParameters = {"userId", "userName", "eventQualificationId", "productId", "productName", "productNum", "productDesc", "createTime", "price", "integration", "images", "isExchange"},
...
public class InquirePageEventQualificationListService implements Service {
        ...
        if (eventQualificationList != null) {
            if (!eventQualificationList.isEmpty()) {
                ...
                for (EventQualification eventQualification : eventQualificationList) {
                    userIdSet.add(eventQualification.getUserId());
                }
...
//                        if (user.getUserId() == eventQualification.getUserId()) {
