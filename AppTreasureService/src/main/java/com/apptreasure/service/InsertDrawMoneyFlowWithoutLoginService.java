 ...
 */
@ServiceConfig(
        act = AppTreasureActionNames.insertDrawMoneyFlowWithoutLogin,
...
public class InsertDrawMoneyFlowWithoutLoginService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InsertDrawMoneyFlowWithoutLoginService.class);
