...
import com.apptreasure.entity.Event;
 ...
 */
@ServiceConfig(
        act = AppTreasureActionNames.inquireEvent,
        ...
        returnParameters = {"eventName", "createTime"},
        description = "查询活动的列表",
        validateParameters = {
    @Field(fieldName = "session", fieldType = FieldTypeEnum.CHAR1024, description = "session信息"),
    @Field(fieldName = "encryptType", fieldType = FieldTypeEnum.TYINT, description = "加密类型")
})
public class InquireEventService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InquireEventService.class);
